                ...
                <div class="card-content">
                    <div class="col-md-12 ">
                         <a href="#"  class="btn btn-primary btn-sm"  title="Add">   
                          ...
                          <a href="{{route('cotizaciones.pendientes')}}"  class="btn btn-success btn-sm"  title="Add">   
                       ...
                       <table class="table table-hover table-condensed">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>55</td>
                                      <td> 
                                        <a href="{{Route('cotizaciones.mostrar')}}"  class="btn btn-success btn-xs editereg" title="Traspaso">

  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <p style="font-size: 20px;">¿Desea eliminar la Categoria <strong><span style="font-size: 20px;" id="name"></span></strong>, del sistema?</p>      
      </div>


      <div class="modal-footer">
        <form id="formDeleteCat" role="form" action="" method="post">

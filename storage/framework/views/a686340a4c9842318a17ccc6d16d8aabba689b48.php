    ...
    <div class="col col-5 col-xs-5 col-sm-5 ">
      <div class="panel ">
        <div class="panel-body">
            <h2>Laboratorio #<?php echo e($items->numeroLaboratorio); ?></h2>
    ...
    <div class="col col-6 col-xs-6 col-sm-6">
        <div class="panel ">
            ...
            <div class="form-group ">
                ...
                <span type="telefonoCliente" id="telefonoCliente"><?php echo e($items->clTelefono); ?></span>
            </div>
        ...
        <div class="panel ">
            ...
            <!-- capsula -->
              ...
              <div class="form-group ">
                  ...
                  <span type="cliente" id="cliente"><?php echo e(date("d-m-Y",strtotime($items->fechaRecepcion))); ?></span>
              </div>

...
<link rel="stylesheet" href="<?php echo e(URL::asset('/bower_components/angular-datatables/dist/css/angular-datatables.css')); ?>">
<link rel="stylesheet" href="<?php echo e(URL::asset('/bower_components/datatables.net-dt/css/jquery.dataTables.css')); ?>"> 
<link rel="stylesheet" href="<?php echo e(URL::asset('/bower_components/angular-bootstrap/ui-bootstrap-csp.css')); ?>">     
...
<script src="<?php echo e(URL::asset('/bower_components/angular-datatables/dist/angular-datatables.min.js')); ?>"></script>

<script src="<?php echo e(URL::asset('/bower_components/angular-bootstrap/ui-bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('/bower_components/angular-bootstrap/ui-bootstrap-tpls.min.js')); ?>"></script>
<!-- Angular Controllers -->
  <script src="<?php echo e(URL::asset('/angularController/appController.js')); ?>"></script>

        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="col-md-12 ">
                         <a href="#"  class="btn btn-primary btn-sm"  title="Add">   
                          ...
                          <a href="<?php echo e(route('cotizaciones.terminadas')); ?>"  class="btn btn-secondary btn-sm"  title="Add">   
                       ...
                       <table class="table table-hover table-condensed">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>55</td>
                                      <td> 
                                        <a href="<?php echo e(Route('cotizaciones.mostrar')); ?>"  class="btn btn-success btn-xs editereg" title="Traspaso">

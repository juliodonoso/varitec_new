...
<body class="off-canvas-sidebar">
    <nav class="navbar navbar-primary navbar-transparent navbar-absolute">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Informes Flex</a>
            </div>
    ...
    <div class="wrapper wrapper-full-page">
                        ...
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                            ...
                            <form class="form-horizontal" method="POST" action="<?php echo e(route('login')); ?>">
                                ...
                                <div class="card card-login" style="background: rgba(255,255,255, 0.8)">
                                    ...
                                    <p class="category text-center" style="color:black">
        ...
        <div class="full-page-background" style="background-image: url('<?php echo e(URL::asset('tim/img/cover.jpeg')); ?>');"></div></div>
    </div>
